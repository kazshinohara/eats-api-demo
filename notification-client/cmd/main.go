...
func (c *notificationClient) getNotification() (pb.Notification_GetNotificationClient, error) {
	return c.client.GetNotification(context.Background(), &pb.NotificationRequest{EventName: c.eventName})
}

func (c *notificationClient) startSubscription() {
	var err error
	var stream pb.Notification_GetNotificationClient
